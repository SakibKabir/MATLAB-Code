...
% %path/row-\P170\R079\--J, South Africa
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=641129;
    UL_y=6911605-equator;
    UR_x=641467;
    UR_y=6911658-equator;
    LR_x=641513;
    LR_y=6911325-equator;
    LL_x=641220;
    LL_y=6911268-equator;
      ...
      % ROI Coordinates
    UL_x=662165;
    UL_y=6900529-equator;
    UR_x=662481;
    UR_y=6900533-equator;
    LR_x=662497;
    LR_y=6900274-equator;
    LL_x=662184;
    LL_y=6900271-equator;



       elseif ROI==3
    UL_x=644124;
    UL_y=6909380-equator;
    UR_x=644470;
    UR_y=6909272-equator;
    LR_x=644362;
    LR_y=6908957-equator;
    LL_x=644028;
    LL_y=6909063-equator;
      ...
      elseif ROI==4
        ...
        % ROI Coordinates
    UL_x=648897;
    UL_y=6913785-equator;
    UR_x=649394;
    UR_y=6913796-equator;
    LR_x=649410;
    LR_y=6913545-equator;
    LL_x=648904;
    LL_y=6913561-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181213_082717_69_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '082717_69_cubicspline.tif');
    Dove_image_file= strcat(base,filesep, dates.name, filesep, '20181213_082717_69_1047_3B_AnalyticMS.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_J_SA2.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_J_SA2.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_J_SA2.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_J_SA2.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_J_SA2.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_J_SA2.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_J_SA2.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_J_SA2.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_J_SA2.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_J_SA2.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_J_SA2.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_J_SA2.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
   
end

     all_mean.Radiance.f_J_SA2 = all_mean_J_SA2;
     all_mean.Reflectance.f_J_SA2 = all_mean_ref_J_SA2;
          
     all_SD.Radiance.f_J_SA2 = all_SD_J_SA2;
     all_SD.Reflectance.f_J_SA2 = all_SD_ref_J_SA2;
     
     all_RSD.Radiance.f_J_SA2 = all_RSD_J_SA2;
     all_RSD.Reflectance.f_J_SA2 = all_RSD_ref_J_SA2;
