...
% %path/row-\P171\R078\--J, South Africa
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=487286;
    UL_y=7050434-equator;
    UR_x=487483;
    UR_y=7050375-equator;
    LR_x=487424;
    LR_y=7050221-equator;
    LL_x=487238;
    LL_y=7050285-equator;
      ...
      % ROI Coordinates
    UL_x=493622;
    UL_y=7052080-equator;
    UR_x=494024;
    UR_y=7052203-equator;
    LR_x=494089;
    LR_y=7051976-equator;
    LL_x=493693;
    LL_y=7051873-equator;

       elseif ROI==3

    UL_x=483486;
    UL_y=7054226-equator;
    UR_x=483819;
    UR_y=7054333-equator;
    LR_x=483920;
    LR_y=7054067-equator;
    LL_x=483623;
    LL_y=7053940-equator;
      ...
      elseif ROI==4
        ...
        % ROI Coordinates
    UL_x=481667;
    UL_y=7046120-equator;
    UR_x=481962;
    UR_y=7046357-equator;
    LR_x=482168;
    LR_y=7046114-equator;
    LL_x=481897;
    LL_y=7045877-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181204_083439_36_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    % Dove_image_file= strcat(base,filesep, dates.name, filesep, '083439_36_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_J_SA3.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_J_SA3.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_J_SA3.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_J_SA3.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_J_SA3.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_J_SA3.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_J_SA3.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_J_SA3.L8.ROI(ROI,:)= Std_L8_TOAref;
     
      %Relative Standard Deviation from Radiance
     all_RSD_J_SA3.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_J_SA3.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_J_SA3.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_J_SA3.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
   
end
     all_mean.Radiance.g_J_SA3 = all_mean_J_SA3;
     all_mean.Reflectance.g_J_SA3 = all_mean_ref_J_SA3;
     
     all_SD.Radiance.g_J_SA3 = all_SD_J_SA3;
     all_SD.Reflectance.g_J_SA3 = all_SD_ref_J_SA3;
     
     all_RSD.Radiance.g_J_SA3 = all_RSD_J_SA3;
     all_RSD.Reflectance.g_J_SA3 = all_RSD_ref_J_SA3;
