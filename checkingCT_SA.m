...
% %path/row- P174\R084--CapeTown, South Africa
...
MData_file=strcat(base, filesep, dates.name, filesep, '20180920_092057_1047_3B_AnalyticMS_metadata.xml');
...
%     Dove_image_file= strcat(base,filesep, dates.name, filesep, '0920057_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_CT_SA1.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_CT_SA1.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_CT_SA1.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_CT_SA1.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_CT_SA1.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_CT_SA1.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_CT_SA1.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_CT_SA1.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_CT_SA1.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_CT_SA1.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_CT_SA1.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_CT_SA1.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
   
end

    all_mean.Radiance.i_CT_SA1 = all_mean_CT_SA1;
    all_mean.Reflectance.i_CT_SA1 = all_mean_ref_CT_SA1;
    
    all_SD.Radiance.i_CT_SA1 = all_SD_CT_SA1;
    all_SD.Reflectance.i_CT_SA1 = all_SD_ref_CT_SA1;
    
    all_RSD.Radiance.i_CT_SA1 = all_RSD_CT_SA1;
    all_RSD.Reflectance.i_CT_SA1 = all_RSD_ref_CT_SA1;
