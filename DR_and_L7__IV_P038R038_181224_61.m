...
% Dove File 
Dove_tif_name = '20181224_180022_61_105e_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20181224_180022_61_105e_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 704527;  UL_y= 3592567;
 UR_x= 704668;  UR_y= 3592519;
 LR_x= 704507;  LR_y= 3592197;
 LL_x= 704358;  LL_y= 3592246;

  elseif ROI==2
 UL_x= 719249;  UL_y= 3600278;
 UR_x= 720158;  UR_y= 3600112;
 LR_x= 720115;  LR_y= 3599633;
 LL_x= 719161;  LL_y= 3599688;

  elseif ROI==3
 UL_x= 701616;  UL_y= 3593687;
 UR_x= 701783;  UR_y= 3593683;

 LR_x1= 701702; LR_y1= 3593567;
 LR_x2= 701625;  LR_y2= 3593507;
 LR_x3= 701617;  LR_y3= 3593419;

 LR_x = [LR_x1 LR_x2 LR_x3];
 LR_y = [LR_y1 LR_y2 LR_y3];

 LL_x= 701498;  LL_y= 3593528;

  elseif ROI==4
 UL_x= 702305;  UL_y= 3596538;
 UR_x= 702456;  UR_y= 3596585;

 LR_x1= 702450; LR_y1= 3596643;
 LR_x2= 702642;  LR_y2= 3596629;
 LR_x3= 702623;  LR_y3= 3596721;

 LR_x = [LR_x1 LR_x2 LR_x3];
 LR_y = [LR_y1 LR_y2 LR_y3];

 LL_x1= 702688;  LL_y1= 3596782;
 LL_x2= 702991;  LL_y2= 3596542;
 LL_x3= 702341;  LL_y3= 3596407;
...
RefMat_dove = [0 -3; 3 0; 698766 3605448];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_181224_61.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_181224_61.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_181224_61.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_181224_61.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_181224_61.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_181224_61.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_181224_61.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_181224_61.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_181224_61.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_181224_61.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_181224_61.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_181224_61.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_105e.Radiance.a_IV_P038R038_181224_61 = all_mean_IV_P038R038_181224_61;
all_mean_DR_105e.Reflectance.a_IV_P038R038_181224_61 = all_mean_ref_IV_P038R038_181224_61;

all_SD_DR_105e.Radiance.a_IV_P038R038_181224_61 = all_SD_IV_P038R038_181224_61;
all_SD_DR_105e.Reflectance.a_IV_P038R038_181224_61= all_SD_ref_IV_P038R038_181224_61;

all_SNR_DR_105e.Radiance.a_IV_P038R038_181224_61 = all_SNR_IV_P038R038_181224_61;
all_SNR_DR_105e.Reflectance.a_IV_P038R038_181224_61 = all_SNR_ref_IV_P038R038_181224_61;
