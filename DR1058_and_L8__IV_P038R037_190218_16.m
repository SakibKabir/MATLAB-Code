...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 704988;  UL_y= 3630470;
 UR_x= 705052; UR_y= 3630406;
 LR_x= 704888;  LR_y= 3630282;
 LL_x= 704822;  LL_y= 3630293;

  elseif ROI==2
 UL_x= 727063;  UL_y= 3625055;
 UR_x= 727134; UR_y= 3625043;
 LR_x= 727137;  LR_y= 3624835;
 LL_x= 727071;  LL_y= 3624886;

  elseif ROI==3
 UL_x= 714871;  UL_y= 3622758;
 UR_x= 715512; UR_y= 3622758;
 LR_x= 715511;  LR_y= 3622606;
 LL_x= 714973;  LL_y= 3622556;

  elseif ROI==4
 UL_x= 727803;  UL_y= 3627752;
 UR_x= 727874; UR_y= 3627755;
 LR_x= 727850;  LR_y= 3627640;
 LL_x= 727794;  LL_y= 3627642;
...
RefMat_dove = [0 -3; 3 0; 701148 3642078];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_190218_16.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_190218_16.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_190218_16.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_190218_16.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_190218_16.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_190218_16.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_190218_16.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_190218_16.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_190218_16.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_190218_16.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_190218_16.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_190218_16.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

all_mean_DR_1058.Radiance.a_IV_P038R037_190218_16 = all_mean_IV_P038R037_190218_16;
all_mean_DR_1058.Reflectance.a_IV_P038R037_190218_16 = all_mean_ref_IV_P038R037_190218_16;

all_SD_DR_1058.Radiance.a_IV_P038R037_190218_16 = all_SD_IV_P038R037_190218_16;
all_SD_DR_1058.Reflectance.a_IV_P038R037_190218_16= all_SD_ref_IV_P038R037_190218_16;

all_SNR_DR_1058.Radiance.a_IV_P038R037_190218_16 = all_SNR_IV_P038R037_190218_16;
all_SNR_DR_1058.Reflectance.a_IV_P038R037_190218_16 = all_SNR_ref_IV_P038R037_190218_16;
