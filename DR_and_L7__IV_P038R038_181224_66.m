...
% Dove File 
Dove_tif_name = '20181224_180024_66_105e_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20181224_180024_66_105e_3B_AnalyticMS_metadata.xml');
...
for ROI = 1:4
  if ROI==1
    % ROI Coordinates
 UL_x= 697454;  UL_y= 3579526;
 UR_x= 697561;  UR_y= 3579521;
 LR_x= 697568;  LR_y= 3579339;
 LL_x= 697460;  LL_y= 3579336;

  elseif ROI==2
 UL_x= 697082;  UL_y= 3576717;
 UR_x= 697145;  UR_y= 3576714;
 LR_x= 697143;  LR_y= 3576780;

 LL_x1= 697285;  LL_y1= 3576782;
 LL_x2= 697229;  LL_y2= 3576561;
 LL_x = [LL_x1 LL_x2];
 LL_y = [LL_y1 LL_y2];

  elseif ROI==3
 UL_x= 711732;    UL_y= 3579602;
 UR_x= 714681;   UR_y= 3579166;
 LR_x= 714482;    LR_y= 3578721;
 LL_x= 711634;    LL_y= 3579125;

  elseif ROI==4
 UL_x1= 703156;  UL_y1= 3578663;
 UL_x2= 703206;  UL_y2= 3578703;
 UL_x3= 703293;  UL_y3= 3578714;
 
 UL_x = [UL_x1 UL_x2 UL_x3];
 UL_y = [UL_y1 UL_y2 UL_y3];

 UR_x1=  703368;   UR_y1= 3578779;
 UR_x2=  703404;   UR_y2= 3578778;
 UR_x3=  703423;   UR_y3= 3578807;

  UR_x = [UR_x1 UR_x2 UR_x3];
  UR_y = [UR_y1 UR_y2 UR_y3];

 LR_x1= 703460; LR_y1= 3578763;
 LR_x2= 703378; LR_y2= 3578737;
 LR_x3= 703237; LR_y3= 3578668;
 
 LR_x = [LR_x1 LR_x2 LR_x3];
 LR_y = [LR_y1 LR_y2 LR_y3];

 LL_x1= 703209;  LL_y1= 3578668;
 LL_x2= 703182;  LL_y2= 3578658;
 LL_x3= 703165;  LL_y3= 3578658;
...
RefMat_dove = [0 -3; 3 0; 696057 3590988];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_181224_66.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_181224_66.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_181224_66.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_181224_66.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_181224_66.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_181224_66.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_181224_66.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_181224_66.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_181224_66.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_181224_66.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_181224_66.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_181224_66.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_105e.Radiance.a_IV_P038R038_181224_66 = all_mean_IV_P038R038_181224_66;
all_mean_DR_105e.Reflectance.a_IV_P038R038_181224_66 = all_mean_ref_IV_P038R038_181224_66;

all_SD_DR_105e.Radiance.a_IV_P038R038_181224_66 = all_SD_IV_P038R038_181224_66;
all_SD_DR_105e.Reflectance.a_IV_P038R038_181224_66= all_SD_ref_IV_P038R038_181224_66;

all_SNR_DR_105e.Radiance.a_IV_P038R038_181224_66 = all_SNR_IV_P038R038_181224_66;
all_SNR_DR_105e.Reflectance.a_IV_P038R038_181224_66 = all_SNR_ref_IV_P038R038_181224_66;
