...
MData_file=strcat(base, dates.name, filesep, '20181007_082530_52_1047_3B_AnalyticMS_metadata.xml');
...
%     end
     ...
     all_mean_Libya4_52.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_Libya4_52.L8.ROI(ROI,:) = mean_L8_TOArad;
     
     all_mean_ref_Libya4_52.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_Libya4_52.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_Libya4_52.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_Libya4_52.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_Libya4_52.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_Libya4_52.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_Libya4_52.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_Libya4_52.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_Libya4_52.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_Libya4_52.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 

end
     all_mean.Radiance.p_Libya4_52 = all_mean_Libya4_52;
     all_mean.Reflectance.p_Libya4_52 = all_mean_ref_Libya4_52;
     
     all_SD.Radiance.p_Libya4_52 = all_SD_Libya4_52;
     all_SD.Reflectance.p_Libya4_52 = all_SD_ref_Libya4_52;
     
     all_RSD.Radiance.p_Libya4_52 = all_RSD_Libya4_52;
     all_RSD.Reflectance.p_Libya4_52 = all_RSD_ref_Libya4_52;
