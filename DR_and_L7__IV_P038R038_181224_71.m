...
% Dove File 
Dove_tif_name = '20181224_180026_71_105e_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20181224_180026_71_105e_3B_AnalyticMS_metadata.xml');
...
for ROI = 1:4
  if ROI==1
    % ROI Coordinates
 UL_x= 694949;  UL_y= 3565324;
 UR_x= 695030;  UR_y= 3565258;
 LR_x= 694895;  LR_y= 3565092;
 LL_x= 694852;  LL_y= 3565129;

  elseif ROI==2
 UL_x= 696606;  UL_y= 3565544;
 UR_x= 696740;  UR_y= 3565631;

 LR_x1 = 696921; LR_y1= 3565549;
 LR_x2= 697018;  LR_y2= 3565613;
 LR_x3= 697049;  LR_y3= 3565586;

 LR_x = [LR_x1 LR_x2 LR_x3];
 LR_y = [LR_y1 LR_y2 LR_y3];

 LL_x1= 696855;  LL_y1= 3565422;
 LL_x2= 696720;  LL_y2= 3565445;

 LL_x = [LL_x1 LL_x2];
 LL_y = [LL_y1 LL_y2];

  elseif ROI==3
 UL_x= 718821;  UL_y= 3566867;
 UR_x= 720296;  UR_y= 3566600;
 LR_x= 720062;  LR_y= 3566064;
 LL_x= 718600;  LL_y= 3566308;

  elseif ROI==4
UL_x1= 702621;  UL_y1= 3569724;
UL_x2= 702680;  UL_y2= 3569724;
UL_x3= 702713;  UL_y3= 3569686;
UL_x = [UL_x1 UL_x2 UL_x3];
UL_y = [UL_y1 UL_y2 UL_y3];

UR_x1= 702681;  UR_y1= 3569658;
UR_x2= 702666;  UR_y2= 3569626;
UR_x3= 702680;  UR_y3= 3569599;
UR_x = [UR_x1 UR_x2 UR_x3];
UR_y = [UR_y1 UR_y2 UR_y3];

 LR_x1 = 702653; LR_y1= 3569589;
 LR_x2= 702620;  LR_y2= 3569612;
 LR_x3= 702601;  LR_y3= 3569656;
 LR_x = [LR_x1 LR_x2 LR_x3];
 LR_y = [LR_y1 LR_y2 LR_y3];

 LL_x1= 702612;  LL_y1= 3569689;
 LL_x2= 702603;  LL_y2= 3569704;
...
RefMat_dove = [0 -3; 3 0; 693378 3576579];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_181224_71.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_181224_71.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_181224_71.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_181224_71.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_181224_71.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_181224_71.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_181224_71.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_181224_71.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_181224_71.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_181224_71.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_181224_71.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_181224_71.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_105e.Radiance.a_IV_P038R038_181224_71 = all_mean_IV_P038R038_181224_71;
all_mean_DR_105e.Reflectance.a_IV_P038R038_181224_71 = all_mean_ref_IV_P038R038_181224_71;

all_SD_DR_105e.Radiance.a_IV_P038R038_181224_71 = all_SD_IV_P038R038_181224_71;
all_SD_DR_105e.Reflectance.a_IV_P038R038_181224_71= all_SD_ref_IV_P038R038_181224_71;

all_SNR_DR_105e.Radiance.a_IV_P038R038_181224_71 = all_SNR_IV_P038R038_181224_71;
all_SNR_DR_105e.Reflectance.a_IV_P038R038_181224_71 = all_SNR_ref_IV_P038R038_181224_71;
