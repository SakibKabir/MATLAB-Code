...
% Dove File 
Dove_tif_name = '20190122_002522_76_1069_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190122_002522_76_1069_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 482037;  UL_y= 5130606 - equator;
 UR_x= 482321;  UR_y= 5130516 - equator;
 LR_x= 482209;  LR_y= 5130247 - equator;
 LL_x= 481934;  LL_y= 5130335 - equator;

  elseif ROI==2
 UL_x= 486030;  UL_y= 5130332 - equator;
 UR_x= 486324;  UR_y= 5130288 - equator;

 LR_x1= 486495;  LR_y1= 5130332 - equator;
 LR_x2= 486512;  LR_y2= 5130407 - equator;
 LR_x3= 486700;  LR_y3= 5130359 - equator;

 LR_x = [LR_x1 LR_x2  LR_x3];
 LR_y = [LR_y1 LR_y2  LR_y3];

 LL_x= 486651;  LL_y= 5130147 - equator;


  elseif ROI==3
 UL_x= 488642;  UL_y= 5133788 - equator;
 UR_x= 488677;  UR_y= 5133812 - equator;

 LR_x1= 488706;  LR_y1= 5133789 - equator;
 LR_x2= 488740;  LR_y2= 5133813 - equator;
 LR_x3= 488813;  LR_y3= 5133721 - equator;

 LR_x = [LR_x1 LR_x2  LR_x3];
 LR_y = [LR_y1 LR_y2  LR_y3];

 LL_x= 488752;  LL_y= 5133672 - equator;

  elseif ROI==4
 UL_x= 486388;  UL_y= 5131304 - equator;
 UR_x= 486506;  UR_y= 5131284 - equator;
 LR_x= 486541;  LR_y= 5131200 - equator;
 LL_x= 486318;  LL_y= 5131236 - equator;
...
RefMat_dove = [0 -3; 3 0; 471690 5151486 - equator];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_NZ_190122_76.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_NZ_190122_76.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_NZ_190122_76.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_NZ_190122_76.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_NZ_190122_76.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_NZ_190122_76.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_NZ_190122_76.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_NZ_190122_76.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_NZ_190122_76.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_NZ_190122_76.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_NZ_190122_76.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_NZ_190122_76.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR.Radiance.b_NZ_190122_76 = all_mean_NZ_190122_76;
all_mean_DR.Reflectance.b_NZ_190122_76 = all_mean_ref_NZ_190122_76;

all_SD_DR.Radiance.b_NZ_190122_76 = all_SD_NZ_190122_76;
all_SD_DR.Reflectance.b_NZ_190122_76= all_SD_ref_NZ_190122_76;

all_SNR_DR.Radiance.b_NZ_190122_76 = all_SNR_NZ_190122_76;
all_SNR_DR.Reflectance.b_NZ_190122_76 = all_SNR_ref_NZ_190122_76;
