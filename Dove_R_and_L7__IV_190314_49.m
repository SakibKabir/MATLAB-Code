...
% Dove File 
Dove_tif_name = '20190314_183949_49_106b_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190314_183949_49_106b_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 665758;  UL_y= 3593407;
 UR_x= 666052;  UR_y= 3593391;
 LR_x= 666055;  LR_y= 3593145;
 LL_x= 665763;  LL_y= 3593153;


  elseif ROI==2
 UL_x= 668911;  UL_y= 3593812;
 UR_x= 668996;  UR_y= 3593768;
 LR_x= 668925;  LR_y= 3593645;
 LL_x= 668847;  LL_y= 3593685;


  elseif ROI==3
 UL_x= 679248;  UL_y= 3603116;
 UR_x= 679463;  UR_y= 3603123;
 LR_x= 679488;  LR_y= 3602886;
 LL_x= 679273;  LL_y= 3602871;


  elseif ROI==4
 UL_x= 675249;  UL_y= 3596972;
 UR_x= 675526;  UR_y= 3596919;
 LR_x= 675484;  LR_y= 3596649;
 LL_x= 675211;  LL_y= 3596648;
...
RefMat_dove = [0 -3; 3 0; 661554 3614436];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_190314_49.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_190314_49.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_190314_49.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_190314_49.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_190314_49.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_190314_49.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_190314_49.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_190314_49.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_190314_49.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_190314_49.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_190314_49.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_190314_49.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR.Radiance.a_IV_190314_49 = all_mean_IV_190314_49;
all_mean_DR.Reflectance.a_IV_190314_49 = all_mean_ref_IV_190314_49;

all_SD_DR.Radiance.a_IV_190314_49 = all_SD_IV_190314_49;
all_SD_DR.Reflectance.a_IV_190314_49= all_SD_ref_IV_190314_49;

all_SNR_DR.Radiance.a_IV_190314_49 = all_SNR_IV_190314_49;
all_SNR_DR.Reflectance.a_IV_190314_49 = all_SNR_ref_IV_190314_49;
