...
MData_file=strcat(base, dates.name, filesep, '20181121_154801_04_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    Dove_image_file= strcat(base,filesep, dates.name, filesep, '20181121_154801_04_1047_3B_AnalyticMS.tif');
...
%     end
     ...
     all_mean_missouri.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_missouri.L8.ROI(ROI,:) = mean_L8_TOArad;
     
     all_mean_ref_missouri.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_missouri.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_missouri.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_missouri.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_missouri.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_missouri.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_missouri.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_missouri.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_missouri.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_missouri.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 

end
     all_mean.Radiance.d_missouri = all_mean_missouri;
     all_mean.Reflectance.d_missouri = all_mean_ref_missouri;
     
     all_SD.Radiance.d_missouri = all_SD_missouri;
     all_SD.Reflectance.d_missouri = all_SD_ref_missouri;
     
     all_RSD.Radiance.d_missouri = all_RSD_missouri;
     all_RSD.Reflectance.d_missouri = all_RSD_ref_missouri;
