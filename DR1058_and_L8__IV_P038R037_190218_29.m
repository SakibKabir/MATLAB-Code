...
% Dove File 
Dove_tif_name = '20190218_180344_29_1058_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190218_180344_29_1058_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 719264;  UL_y= 3599323;
 UR_x= 720162; UR_y= 3599134;
 LR_x= 720052;  LR_y= 3598560;
 LL_x= 719200;  LL_y= 3598714;

  elseif ROI==2
 UL_x= 697422;  UL_y= 3603605;
 UR_x= 697724; UR_y= 3603596;
 LR_x= 697723;  LR_y= 3603298;
 LL_x= 697411;  LL_y= 3603298;

  elseif ROI==3
 UL_x= 698452;  UL_y= 3597309;
 UR_x= 698804; UR_y= 3597405;
 LR_x= 698815;  LR_y= 3597173;
 LL_x= 698493;  LL_y= 3597109;

  elseif ROI==4
 UL_x= 711880;  UL_y= 3604681;
 UR_x= 712143; UR_y= 3604690;
 LR_x= 712153;  LR_y= 3604411;
 LL_x= 711890;  LL_y= 3604388;
...
RefMat_dove = [0 -3; 3 0; 695658 3613158];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_190218_29.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_190218_29.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_190218_29.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_190218_29.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_190218_29.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_190218_29.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_190218_29.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_190218_29.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_190218_29.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_190218_29.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_190218_29.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_190218_29.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

% all_mean_DR_1058.Radiance.a_IV_P038R037_190218_29 = all_mean_IV_P038R037_190218_29;
% all_mean_DR_1058.Reflectance.a_IV_P038R037_190218_29 = all_mean_ref_IV_P038R037_190218_29;
% 
% all_SD_DR_1058.Radiance.a_IV_P038R037_190218_29 = all_SD_IV_P038R037_190218_29;
% all_SD_DR_1058.Reflectance.a_IV_P038R037_190218_29= all_SD_ref_IV_P038R037_190218_29;
% 
% all_SNR_DR_1058.Radiance.a_IV_P038R037_190218_29 = all_SNR_IV_P038R037_190218_29;
% all_SNR_DR_1058.Reflectance.a_IV_P038R037_190218_29 = all_SNR_ref_IV_P038R037_190218_29;
% 
