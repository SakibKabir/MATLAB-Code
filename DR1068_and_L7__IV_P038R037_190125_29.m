...
% %path/row- 
base='Z:\SpecialNeeds\Sakib\DoveData\April Data\Dove-R Data\1068\20190125\P038\R037';
...
% Dove File 
Dove_tif_name = '20190125_184152_29_1068_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190125_184152_29_1068_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 689210;  UL_y= 3624678;
 UR_x= 690698; UR_y= 3624480;
 LR_x= 690980;  LR_y= 3624012;
 LL_x= 689360;  LL_y= 3624210;


  elseif ROI==2
 UL_x= 697878;  UL_y= 3631991;
 UR_x= 698300; UR_y= 3632072;
 LR_x= 698180;  LR_y= 3631756;
 LL_x= 697851;  LL_y= 3631768;


  elseif ROI==3
 UL_x= 691248;  UL_y= 3614267;
 UR_x= 691452; UR_y= 3614364;
 LR_x= 691558;  LR_y= 3614109;
 LL_x= 691360;  LL_y= 3614003;


  elseif ROI==4
 UL_x= 692739;  UL_y= 3617050;
 UR_x= 692905; UR_y= 3617018;
 LR_x= 692950;  LR_y= 3616744;
 LL_x= 692751;  LL_y= 3616754;
...
RefMat_dove = [0 -3; 3 0; 683577 3634800];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_190125_29.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_190125_29.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_190125_29.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_190125_29.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_190125_29.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_190125_29.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_190125_29.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_190125_29.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_190125_29.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_190125_29.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_190125_29.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_190125_29.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_1068.Radiance.a_IV_P038R037_190125_29 = all_mean_IV_P038R037_190125_29;
all_mean_DR_1068.Reflectance.a_IV_P038R037_190125_29 = all_mean_ref_IV_P038R037_190125_29;

all_SD_DR_1068.Radiance.a_IV_P038R037_190125_29 = all_SD_IV_P038R037_190125_29;
all_SD_DR_1068.Reflectance.a_IV_P038R037_190125_29= all_SD_ref_IV_P038R037_190125_29;

all_SNR_DR_1068.Radiance.a_IV_P038R037_190125_29 = all_SNR_IV_P038R037_190125_29;
all_SNR_DR_1068.Reflectance.a_IV_P038R037_190125_29 = all_SNR_ref_IV_P038R037_190125_29;
