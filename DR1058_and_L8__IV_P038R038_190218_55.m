...
% Dove File 
Dove_tif_name = '20190218_180352_55_1058_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190218_180352_55_1058_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 708760;  UL_y= 3550243;
 UR_x= 709123; UR_y= 3550226;
 LR_x= 709220;  LR_y= 3550027;
 LL_x= 708808;  LL_y= 3550001;

  elseif ROI==2
 UL_x= 692311;  UL_y= 3550810;
 UR_x= 692497; UR_y= 3550813;
 LR_x= 692494;  LR_y= 3550662;
 LL_x= 692312;  LL_y= 3550662;

  elseif ROI==3
 UL_x= 687549;  UL_y= 3538858;
 UR_x= 687721; UR_y= 3538896;
 LR_x= 687816;  LR_y= 3538748;
 LL_x= 687637;  LL_y= 3538698;

  elseif ROI==4
 UL_x= 688637;  UL_y= 3554501;
 UR_x= 688826; UR_y= 3554410;
 LR_x= 688809;  LR_y= 3554374;
 LL_x= 688623;  LL_y= 3554469;
...
RefMat_dove = [0 -3; 3 0; 684600 3555240];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190218_55.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190218_55.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190218_55.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190218_55.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190218_55.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190218_55.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190218_55.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190218_55.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190218_55.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190218_55.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190218_55.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190218_55.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

all_mean_DR_1058.Radiance.a_IV_P038R038_190218_55 = all_mean_IV_P038R038_190218_55;
all_mean_DR_1058.Reflectance.a_IV_P038R038_190218_55 = all_mean_ref_IV_P038R038_190218_55;

all_SD_DR_1058.Radiance.a_IV_P038R038_190218_55 = all_SD_IV_P038R038_190218_55;
all_SD_DR_1058.Reflectance.a_IV_P038R038_190218_55= all_SD_ref_IV_P038R038_190218_55;

all_SNR_DR_1058.Radiance.a_IV_P038R038_190218_55 = all_SNR_IV_P038R038_190218_55;
all_SNR_DR_1058.Reflectance.a_IV_P038R038_190218_55 = all_SNR_ref_IV_P038R038_190218_55;
