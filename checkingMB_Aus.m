...
% % Path/row-093/086- Melbourne, Australia
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=242769;
    UL_y=5836495-equator;
    UR_x=242919;
    UR_y=5836479-equator;
    LR_x=242902;
    LR_y=5836353-equator;
    LL_x=242769;
    LL_y=5836367-equator;


        elseif ROI==2

    UL_x=241837;
    UL_y=5835400-equator;
    UR_x=241966;
    UR_y=5835400-equator;
    LR_x=241946;
    LR_y=5835269-equator;
    LL_x=241847;
    LL_y=5835260-equator;


       elseif ROI==3

    UL_x=250014;
    UL_y=5836965-equator;
    UR_x=250060;
    UR_y=5836955-equator;
    LR_x=250031;
    LR_y=5836873-equator;
    LL_x=249986;
    LL_y=5836882-equator;
      ...
      elseif ROI==4
        ...
        % ROI Coordinates
   UL_x=251352;
    UL_y=5834383-equator;
    UR_x=251482;
    UR_y=5834389-equator;
    LR_x=251506;
    LR_y=5834270-equator;
    LL_x=251405;
    LL_y=5834257-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181116_005548_35_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '005548_35_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_MB_Aus.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_MB_Aus.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_MB_Aus.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_MB_Aus.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_MB_Aus.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_MB_Aus.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_MB_Aus.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_MB_Aus.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_MB_Aus.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_MB_Aus.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_MB_Aus.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_MB_Aus.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
end
     all_mean.Radiance.o_MB_Aus = all_mean_MB_Aus;
     all_mean.Reflectance.o_MB_Aus = all_mean_ref_MB_Aus;
     
     all_SD.Radiance.o_MB_Aus = all_SD_MB_Aus;
     all_SD.Reflectance.o_MB_Aus = all_SD_ref_MB_Aus;
     
     all_RSD.Radiance.o_MB_Aus = all_RSD_MB_Aus;
     all_RSD.Reflectance.o_MB_Aus = all_RSD_ref_MB_Aus;
