...
% Dove File 
Dove_tif_name = '20190218_180346_36_1058_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190218_180346_36_1058_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 716663;  UL_y= 3579367;
 UR_x= 717190;  UR_y= 3579321;
 LR_x= 717365;  LR_y= 3578846;
 LL_x= 716764;  LL_y= 3578827;

  elseif ROI==2
 UL_x= 699825;  UL_y= 3588179;
 UR_x= 700263; UR_y= 3587855;
 LR_x= 700144;  LR_y= 3587644;
 LL_x= 699717;  LL_y= 3587993;

  elseif ROI==3
 UL_x= 700096;  UL_y= 3588882;
 UR_x= 700419; UR_y= 3588612;
 LR_x= 700092;  LR_y= 3588641;
 LL_x= 700000;  LL_y= 3588698;

  elseif ROI==4
 UL_x= 697830;  UL_y= 3587277;
 UR_x= 698174; UR_y= 3587282;
 LR_x= 698161;  LR_y= 3587116;
 LL_x= 697843;  LL_y= 3587106;
...
RefMat_dove = [0 -3; 3 0; 692901 3598653];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190218_36.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190218_36.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190218_36.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190218_36.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190218_36.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190218_36.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190218_36.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190218_36.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190218_36.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190218_36.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190218_36.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190218_36.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

all_mean_DR_1058.Radiance.a_IV_P038R038_190218_36 = all_mean_IV_P038R038_190218_36;
all_mean_DR_1058.Reflectance.a_IV_P038R038_190218_36 = all_mean_ref_IV_P038R038_190218_36;

all_SD_DR_1058.Radiance.a_IV_P038R038_190218_36 = all_SD_IV_P038R038_190218_36;
all_SD_DR_1058.Reflectance.a_IV_P038R038_190218_36= all_SD_ref_IV_P038R038_190218_36;

all_SNR_DR_1058.Radiance.a_IV_P038R038_190218_36 = all_SNR_IV_P038R038_190218_36;
all_SNR_DR_1058.Reflectance.a_IV_P038R038_190218_36 = all_SNR_ref_IV_P038R038_190218_36;
