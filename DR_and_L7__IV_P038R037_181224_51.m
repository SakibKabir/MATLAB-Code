...
% Dove File 
Dove_tif_name = '20181224_180018_51_105e_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20181224_180018_51_105e_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 714778;  UL_y= 3619517;
 UR_x= 715117;  UR_y= 3619521;
 LR_x= 715117;  LR_y= 3619389;
 LL_x= 714775;  LL_y= 3619386;

  elseif ROI==2
UL_x= 727848;  UL_y= 3625505;
 UR_x= 728130;  UR_y= 3625507;
 LR_x= 728130;  LR_y= 3625396;
 LL_x= 727854;  LL_y= 3625388;

  elseif ROI==3
 UL_x= 727198;  UL_y= 3628303;
 UR_x= 727456;  UR_y= 3628226;
 LR_x1= 727398;  LR_y1= 3628055;
 LR_x2= 727247;  LR_y2= 3628086;
 LR_x3= 727184;  LR_y3= 3628036;
 LR_x = [LR_x1 LR_x2  LR_x3];
 LR_y = [LR_y1 LR_y2  LR_y3];

 LL_x= 727081;  LL_y= 3628060;

  elseif ROI==4
 UL_x= 729968;  UL_y= 3621156;
 UR_x= 730666;  UR_y= 3621173;
 LR_x= 730664;  LR_y= 3621059;
 LL_x= 729974;  LL_y= 3621035;
...
%Map coordinate to pixel coordinate and Mask
...
RefMat_dove = [0 -3; 3 0; 704295 3634260];

%Map coordinate to pixel coordinate and Mask creation
...
MeanTOAref_Dove_ROI = nanmean(nanmean(Dove_TOAref_ROI));
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_181224_51.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_181224_51.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_181224_51.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_181224_51.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_181224_51.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_181224_51.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_181224_51.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_181224_51.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_181224_51.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_181224_51.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_181224_51.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_181224_51.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_105e.Radiance.a_IV_P038R037_181224_51 = all_mean_IV_P038R037_181224_51;
all_mean_DR_105e.Reflectance.a_IV_P038R037_181224_51 = all_mean_ref_IV_P038R037_181224_51;

all_SD_DR_105e.Radiance.a_IV_P038R037_181224_51 = all_SD_IV_P038R037_181224_51;
all_SD_DR_105e.Reflectance.a_IV_P038R037_181224_51= all_SD_ref_IV_P038R037_181224_51;

all_SNR_DR_105e.Radiance.a_IV_P038R037_181224_51 = all_SNR_IV_P038R037_181224_51;
all_SNR_DR_105e.Reflectance.a_IV_P038R037_181224_51 = all_SNR_ref_IV_P038R037_181224_51;
