...
% Dove File 
Dove_tif_name = '20190211_184255_25_106f_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190211_184255_25_106f_3B_AnalyticMS_metadata.xml');
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_190211_25.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_190211_25.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_190211_25.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_190211_25.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_190211_25.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_190211_25.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_190211_25.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_190211_25.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_190211_25.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_190211_25.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_190211_25.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_190211_25.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR.Radiance.a_IV_190211_25 = all_mean_IV_190211_25;
all_mean_DR.Reflectance.a_IV_190211_25 = all_mean_ref_IV_190211_25;

all_SD_DR.Radiance.a_IV_190211_25 = all_SD_IV_190211_25;
all_SD_DR.Reflectance.a_IV_190211_25= all_SD_ref_IV_190211_25;

all_SNR_DR.Radiance.a_IV_190211_25 = all_SNR_IV_190211_25;
all_SNR_DR.Reflectance.a_IV_190211_25 = all_SNR_ref_IV_190211_25;
