...
% %path/row-\P170\R078\--J, South Africa
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=621569;
    UL_y=7049519-equator;
    UR_x=621963;
    UR_y=7049532-equator;
    LR_x=621969;
    LR_y=7049258-equator;
    LL_x=621583;
    LL_y=7049247-equator;
  ...
  elseif ROI==2
    ...
    % ROI Coordinates
    UL_x=635990;
    UL_y=7039988-equator;
    UR_x=636196;
    UR_y=7040107-equator;
    LR_x=636450;
    LR_y=7039958-equator;
    LL_x=636251;
    LL_y=7039850-equator;


       elseif ROI==3

    UL_x=634223;
    UL_y=7044624-equator;
    UR_x=634822;
    UR_y=7044714-equator;
    LR_x=634897;
    LR_y=7044450-equator;
    LL_x=634296;
    LL_y=7044341-equator;

      elseif ROI==4

        % ROI Coordinates
    UL_x=637133;
    UL_y=7050349-equator;
    UR_x=637597;
    UR_y=7050567-equator;
    LR_x=637702;
    LR_y=7050329-equator;
    LL_x=637250;
    LL_y=7050092-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181213_082737_49_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '082737_cubicspline.tif');
    Dove_image_file= strcat(base,filesep, dates.name, filesep, '20181213_082737_49_1047_3B_AnalyticMS.tif');
...
%     end
     ...
     all_mean_J_SA1.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_J_SA1.L8.ROI(ROI,:) = mean_L8_TOArad;
     % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_J_SA1.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_J_SA1.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_J_SA1.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_J_SA1.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_J_SA1.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_J_SA1.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_J_SA1.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_J_SA1.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_J_SA1.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_J_SA1.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
end
     all_mean.Radiance.e_J_SA1 = all_mean_J_SA1;
     all_mean.Reflectance.e_J_SA1 = all_mean_ref_J_SA1;
     
     all_SD.Radiance.e_J_SA1 = all_SD_J_SA1;
     all_SD.Reflectance.e_J_SA1 = all_SD_ref_J_SA1;
     
     all_RSD.Radiance.e_J_SA1 = all_RSD_J_SA1;
     all_RSD.Reflectance.e_J_SA1 = all_RSD_ref_J_SA1;
