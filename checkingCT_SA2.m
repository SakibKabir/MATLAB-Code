...
% %path/row- P175\R083--CapeTown, South Africa
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=264221;
    UL_y=6334204-equator;
    UR_x=264480;
    UR_y=6334183-equator;
    LR_x=264450;
    LR_y=6333868-equator;
    LL_x=264210;
    LL_y=6333893-equator;
      ...
      % ROI Coordinates
    UL_x=266337;
    UL_y=6329823-equator;
    UR_x=266444;
    UR_y=6329832-equator;
    LR_x=266458;
    LR_y=6329644-equator;
    LL_x=266355;
    LL_y=6329641-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20180911_092543_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '092543_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_CT_SA2.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_CT_SA2.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_CT_SA2.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_CT_SA2.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_CT_SA2.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_CT_SA2.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_CT_SA2.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_CT_SA2.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_CT_SA2.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_CT_SA2.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_CT_SA2.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_CT_SA2.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
   
end

    all_mean.Radiance.j_CT_SA2 = all_mean_CT_SA2;
    all_mean.Reflectance.j_CT_SA2 = all_mean_ref_CT_SA2;
    
    all_SD.Radiance.j_CT_SA2 = all_SD_CT_SA2;
    all_SD.Reflectance.j_CT_SA2 = all_SD_ref_CT_SA2;
    
    all_RSD.Radiance.j_CT_SA2 = all_RSD_CT_SA2;
    all_RSD.Reflectance.j_CT_SA2 = all_RSD_ref_CT_SA2;
