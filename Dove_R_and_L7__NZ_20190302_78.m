...
% Dove File 
Dove_tif_name = '20190302_002410_78_106e_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190302_002410_78_106e_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 485355;  UL_y= 5127854 - equator;
 UR_x= 485830;  UR_y= 5127671 - equator;

 LR_x1 = 485823;  LR_y1= 5127596 - equator;
 LR_x2 = 485640;  LR_y2= 5127518 - equator;
 LR_x =[LR_x1 LR_x2];
 LR_y=[LR_y1 LR_y2];

 LL_x1 = 485542;  LL_y1= 5127375 - equator;
 LL_x2 = 485241;  LL_y2= 5127490 - equator;
 LL_x =[LL_x1 LL_x2];
 LL_y=[LL_y1 LL_y2];

  elseif ROI==2
 UL_x= 484751;  UL_y= 5122979 - equator;
 UR_x= 484895;  UR_y= 5122902 - equator;
 LR_x= 484774;  LR_y= 5122673 - equator;
 LL_x= 484629;  LL_y= 5122733 - equator;

  elseif ROI==3
 UL_x= 485335;  UL_y= 5121451 - equator;
 UR_x= 485500;  UR_y= 5121364 - equator;
 LR_x= 485469;  LR_y= 5121210 - equator;

 LL_x1 = 485401;  LL_y1= 5121256 - equator;
 LL_x2 = 485290;  LL_y2= 5121255 - equator;
 LL_x =[LL_x1 LL_x2];
 LL_y=[LL_y1 LL_y2];

  elseif ROI==4
 UL_x= 484045;  UL_y= 5126108 - equator;
 UR_x= 484319;  UR_y= 5126027 - equator;
 LR_x= 484199;  LR_y= 5125789 - equator;
 LL_x= 483948;  LL_y= 5125903 - equator;
...
RefMat_dove = [0 -3; 3 0; 479217 5132706 - equator];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_NZ_190302_78.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_NZ_190302_78.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_NZ_190302_78.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_NZ_190302_78.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_NZ_190302_78.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_NZ_190302_78.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_NZ_190302_78.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_NZ_190302_78.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_NZ_190302_78.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_NZ_190302_78.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_NZ_190302_78.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_NZ_190302_78.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR.Radiance.b_NZ_190302_78 = all_mean_NZ_190302_78;
all_mean_DR.Reflectance.b_NZ_190302_78 = all_mean_ref_NZ_190302_78;

all_SD_DR.Radiance.b_NZ_190302_78 = all_SD_NZ_190302_78;
all_SD_DR.Reflectance.b_NZ_190302_78= all_SD_ref_NZ_190302_78;

all_SNR_DR.Radiance.b_NZ_190302_78 = all_SNR_NZ_190302_78;
all_SNR_DR.Reflectance.b_NZ_190302_78 = all_SNR_ref_NZ_190302_78;
