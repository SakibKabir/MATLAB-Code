...
% Dove File 
Dove_tif_name = '20190125_184141_85_1068_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190125_184141_85_1068_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 709583;  UL_y= 3551010;
 UR_x= 710698; UR_y= 3550816;
 LR_x= 710483;  LR_y= 3550268;
 LL_x= 709488;  LL_y= 3550434;

  elseif ROI==2
 UL_x= 725667;  UL_y= 3551645;
 UR_x= 726431; UR_y= 3551523;
 LR_x= 726185;  LR_y= 3550922;
 LL_x= 725628;  LL_y= 3551006;

  elseif ROI==3
UL_x= 715776;  UL_y= 3549181;
 UR_x= 716012; UR_y= 3549173;
 LR_x= 716024;  LR_y= 3548875;
 LL_x= 715819;  LL_y= 3548930;

  elseif ROI==4
 UL_x= 708556;  UL_y= 3558048;
 UR_x= 709593; UR_y= 3557925;
 LR_x= 709322;  LR_y= 3557359;
 LL_x= 708316;  LL_y= 3557464;
...
RefMat_dove = [0 -3; 3 0; 699876 3562275];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190125_85.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190125_85.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190125_85.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190125_85.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190125_85.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190125_85.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190125_85.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190125_85.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190125_85.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190125_85.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190125_85.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190125_85.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_1068.Radiance.a_IV_P038R038_190125_85 = all_mean_IV_P038R038_190125_85;
all_mean_DR_1068.Reflectance.a_IV_P038R038_190125_85 = all_mean_ref_IV_P038R038_190125_85;

all_SD_DR_1068.Radiance.a_IV_P038R038_190125_85 = all_SD_IV_P038R038_190125_85;
all_SD_DR_1068.Reflectance.a_IV_P038R038_190125_85= all_SD_ref_IV_P038R038_190125_85;

all_SNR_DR_1068.Radiance.a_IV_P038R038_190125_85 = all_SNR_IV_P038R038_190125_85;
all_SNR_DR_1068.Reflectance.a_IV_P038R038_190125_85 = all_SNR_ref_IV_P038R038_190125_85;
