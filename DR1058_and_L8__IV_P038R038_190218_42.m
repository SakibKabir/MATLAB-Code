...
% Dove File 
Dove_tif_name = '20190218_180348_42_1058_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190218_180348_42_1058_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 712331;  UL_y= 3568024;
 UR_x= 713591; UR_y= 3567745;
 LR_x= 713378;  LR_y= 3567253;
 LL_x= 712220;  LL_y= 3567538;

  elseif ROI==2
 UL_x= 695002;  UL_y= 3572311;
 UR_x= 695303; UR_y= 3572299;
 LR_x= 695292;  LR_y= 3572130;
 LL_x= 695016;  LL_y= 3572151;

  elseif ROI==3
 UL_x= 693903;  UL_y= 3572582;
 UR_x= 694126; UR_y= 3572558;
 LR_x= 694127;  LR_y= 3572376;
 LL_x= 693936;  LL_y= 3572379;

  elseif ROI==4
 UL_x= 696371;  UL_y= 3576934;
 UR_x= 696559; UR_y= 3576925;
 LR_x= 696362;  LR_y= 3576600;
 LL_x= 696179;  LL_y= 3576592;
...
RefMat_dove = [0 -3; 3 0; 690126 3584151];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190218_42.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190218_42.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190218_42.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190218_42.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190218_42.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190218_42.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190218_42.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190218_42.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190218_42.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190218_42.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190218_42.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190218_42.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

all_mean_DR_1058.Radiance.a_IV_P038R038_190218_42 = all_mean_IV_P038R038_190218_42;
all_mean_DR_1058.Reflectance.a_IV_P038R038_190218_42 = all_mean_ref_IV_P038R038_190218_42;

all_SD_DR_1058.Radiance.a_IV_P038R038_190218_42 = all_SD_IV_P038R038_190218_42;
all_SD_DR_1058.Reflectance.a_IV_P038R038_190218_42= all_SD_ref_IV_P038R038_190218_42;

all_SNR_DR_1058.Radiance.a_IV_P038R038_190218_42 = all_SNR_IV_P038R038_190218_42;
all_SNR_DR_1058.Reflectance.a_IV_P038R038_190218_42 = all_SNR_ref_IV_P038R038_190218_42;
