...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 712026;  UL_y= 3616623;
 UR_x= 712219; UR_y= 3616622;
 LR_x= 712221;  LR_y= 3616504;
 LL_x= 712032;  LL_y= 3616503;

  elseif ROI==2
 UL_x= 689202;  UL_y= 3605590;
 UR_x= 689604; UR_y= 3605837;
 LR_x= 689729;  LR_y= 3605652;

 LL_x1= 689431;  LL_y1= 3605464;
 LL_x2= 689260;  LL_y2= 3605464;

 LL_x = [LL_x1 LL_x2];
 LL_y = [LL_y1 LL_y2];

  elseif ROI==3
 UL_x1= 704366;  UL_y1= 3601877;
 UL_x2= 704438;  UL_y2= 3601869;
      
 UL_x = [UL_x1  UL_x2];
 UL_y = [UL_y1  UL_y2];

 UR_x1= 704439; UR_y1= 3601800;
 UR_x2= 704496; UR_y2= 3601750;

 UR_x = [UR_x1 UR_x2];
 UR_y = [UR_y1 UR_y2];

 LR_x= 704440;  LR_y= 3601686;
 LL_x= 704364;  LL_y= 3601725;

  elseif ROI==4
 UL_x= 705837;  UL_y= 3615503;
 UR_x= 706072; UR_y= 3615478;
 LR_x= 706117;  LR_y= 3615289;
 LL_x= 705917;  LL_y= 3615176;
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_190125_20.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_190125_20.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_190125_20.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_190125_20.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_190125_20.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_190125_20.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_190125_20.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_190125_20.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_190125_20.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_190125_20.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_190125_20.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_190125_20.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_1068.Radiance.a_IV_P038R037_190125_20 = all_mean_IV_P038R037_190125_20;
all_mean_DR_1068.Reflectance.a_IV_P038R037_190125_20 = all_mean_ref_IV_P038R037_190125_20;

all_SD_DR_1068.Radiance.a_IV_P038R037_190125_20 = all_SD_IV_P038R037_190125_20;
all_SD_DR_1068.Reflectance.a_IV_P038R037_190125_20= all_SD_ref_IV_P038R037_190125_20;

all_SNR_DR_1068.Radiance.a_IV_P038R037_190125_20 = all_SNR_IV_P038R037_190125_20;
all_SNR_DR_1068.Reflectance.a_IV_P038R037_190125_20 = all_SNR_ref_IV_P038R037_190125_20;
