...
% %path/row- 
base='Z:\SpecialNeeds\Sakib\DoveData\April Data\Dove-R Data\1058\20190218\P038\R037';
...
% Dove File 
Dove_tif_name = '20190218_180342_22_1058_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190218_180342_22_1058_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 710762;  UL_y= 3620141;
 UR_x= 710843; UR_y= 3620076;
 LR_x= 710757;  LR_y= 3619919;

 LL_x1= 710816;  LL_y1= 3619864;
 LL_x2= 710761;  LL_y2= 3619780;
 LL_x3= 710629;  LL_y3= 3619904;

 LL_x =[LL_x1 LL_x2 LL_x3] ;
 LL_y =[LL_y1 LL_y2 LL_y3] ;

  elseif ROI==2
 UL_x= 702378;  UL_y= 3621891;
 UR_x= 703107; UR_y= 3621528;
 LR_x= 702541;  LR_y= 3621403;
 LL_x= 702150;  LL_y= 3621645;

  elseif ROI==3
 UL_x= 705076;  UL_y= 3612944;
 UR_x= 705369; UR_y= 3613019;
 LR_x= 705468;  LR_y= 3612675;
 LL_x= 705100;  LL_y= 3612677;

  elseif ROI==4
 UL_x= 715025;  UL_y= 3622167;
 UR_x= 715325; UR_y= 3622165;
 LR_x= 715326;  LR_y= 3622035;
 LL_x= 715033;  LL_y= 3622028;
...
RefMat_dove = [0 -3; 3 0; 698382 3627618];
...
Std_L8_TOAref(D_band)= std(temp_L8_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R037_190218_22.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R037_190218_22.L8.ROI(ROI,:) = mean_L8_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R037_190218_22.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R037_190218_22.L8.ROI(ROI,:) = mean_L8_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R037_190218_22.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R037_190218_22.L8.ROI(ROI,:)= Std_L8_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R037_190218_22.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R037_190218_22.L8.ROI(ROI,:)= Std_L8_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R037_190218_22.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R037_190218_22.L8.ROI(ROI,:) = mean_L8_TOArad./Std_L8_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R037_190218_22.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R037_190218_22.L8.ROI(ROI,:) = mean_L8_TOAref./Std_L8_TOAref; 
end

all_mean_DR_1058.Radiance.a_IV_P038R037_190218_22 = all_mean_IV_P038R037_190218_22;
all_mean_DR_1058.Reflectance.a_IV_P038R037_190218_22 = all_mean_ref_IV_P038R037_190218_22;

all_SD_DR_1058.Radiance.a_IV_P038R037_190218_22 = all_SD_IV_P038R037_190218_22;
all_SD_DR_1058.Reflectance.a_IV_P038R037_190218_22= all_SD_ref_IV_P038R037_190218_22;

all_SNR_DR_1058.Radiance.a_IV_P038R037_190218_22 = all_SNR_IV_P038R037_190218_22;
all_SNR_DR_1058.Reflectance.a_IV_P038R037_190218_22 = all_SNR_ref_IV_P038R037_190218_22;
