...
% Dove File 
Dove_tif_name = '20190211_184251_02_106f_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190211_184251_02_106f_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 693751;  UL_y= 3573870;
 UR_x= 694121;  UR_y= 3573800;
 LR_x= 694023;  LR_y= 3573607;
 LL_x= 693787;  LL_y= 3573649;

  elseif ROI==2
 UL_x= 688365;  UL_y= 3567767;
 UR_x= 688611;  UR_y= 3567777;
 LR_x= 688613;  LR_y= 3567602;
 LL_x= 688372;  LL_y= 3567589;


  elseif ROI==3
 UL_x= 685886;  UL_y= 3570085;
 UR_x= 686106;  UR_y= 3570061;
 LR_x= 686087;  LR_y= 3569811;
 LL_x= 685816;  LL_y= 3569800;

  elseif ROI==4
 UL_x= 682764;  UL_y= 3575538;
 UR_x= 683018;  UR_y= 3575513;
 LR_x= 682982;  LR_y= 3575363;
 LL_x= 682742;  LL_y= 3575363;
...
RefMat_dove = [0 -3; 3 0; 676593 3583098];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_190211_02.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_190211_02.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_190211_02.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_190211_02.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_190211_02.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_190211_02.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_190211_02.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_190211_02.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_190211_02.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_190211_02.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_190211_02.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_190211_02.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR.Radiance.a_IV_190211_02 = all_mean_IV_190211_02;
all_mean_DR.Reflectance.a_IV_190211_02 = all_mean_ref_IV_190211_02;

all_SD_DR.Radiance.a_IV_190211_02 = all_SD_IV_190211_02;
all_SD_DR.Reflectance.a_IV_190211_02= all_SD_ref_IV_190211_02;

all_SNR_DR.Radiance.a_IV_190211_02 = all_SNR_IV_190211_02;
all_SNR_DR.Reflectance.a_IV_190211_02 = all_SNR_ref_IV_190211_02;
