...
MData_file=strcat(base, dates.name, filesep, '20181121_154814_90_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    Dove_image_file= strcat(base,filesep, dates.name, filesep, '154814_90_cubicspline.tif');
    L8_image_file_reprojected= strcat(base, dates.name, filesep, 'L8_band2_reprojected.tif');
    [DN, R_L8] = geotiffread(L8_image_file_reprojected);
