...
% %path/row-\P171\R079\--J, South Africa
...
for ROI=1:4
  ...
  if ROI==1
    % ROI Coordinates
    UL_x=507324;
    UL_y=6898587-equator;
    UR_x=507709;
    UR_y=6898862-equator;
    LR_x=508144;
    LR_y=6898388-equator;
    LL_x=507721;
    LL_y=6898132-equator;
      ...
      % ROI Coordinates
    UL_x=522514;
    UL_y=6902550-equator;
    UR_x=522738;
    UR_y=6902419-equator;
    LR_x=522465;
    LR_y=6902018-equator;
    LL_x=522257;
    LL_y=6902133-equator;


       elseif ROI==3

    UL_x=528546;
    UL_y=6896685-equator;
    UR_x=529009;
    UR_y=6896768-equator;
    LR_x=529066;
    LR_y=6896497-equator;
    LL_x=528602;
    LL_y=6896408-equator;
      ...
      elseif ROI==4
        ...
        % ROI Coordinates
    UL_x=524520;
    UL_y=6901970-equator;
    UR_x=525054;
    UR_y=6902315-equator;
    LR_x=525516;
    LR_y=6901926-equator;
    LL_x=525062;
    LL_y=6901641-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181204_083417_58_1047_3B_AnalyticMS_metadata.xml');
[MData_values]= xml2struct_new_v(MData_file);
[MData_values_old]= xml2struct(MData_file);

acquisition_date = MTL_List_L8.PRODUCT_METADATA.DATE_ACQUIRED;
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '083417_58_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_J_SA4.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_J_SA4.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_J_SA4.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_J_SA4.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_J_SA4.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_J_SA4.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_J_SA4.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_J_SA4.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_J_SA4.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_J_SA4.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_J_SA4.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_J_SA4.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
end

     all_mean.Radiance.h_J_SA4 = all_mean_J_SA4;
     all_mean.Reflectance.h_J_SA4 = all_mean_ref_J_SA4;
     
     all_SD.Radiance.h_J_SA4 = all_SD_J_SA4;
     all_SD.Reflectance.h_J_SA4 = all_SD_ref_J_SA4;
     
     all_RSD.Radiance.h_J_SA4 = all_RSD_J_SA4;
     all_RSD.Reflectance.h_J_SA4 = all_RSD_ref_J_SA4;
