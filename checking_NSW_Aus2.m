...
% % Path/row-091/082- New South Wells, Australia
...
for ROI=1:4
  ...
  if ROI==1
    ...
    UL_x=670712;
    UL_y=6407484-equator;
    UR_x=671000;
    UR_y=6407504-equator;
    LR_x=671002;
    LR_y=6407189-equator;
    LL_x=670739;
    LL_y=6407191-equator;


       elseif ROI==3

    UL_x=684227;
    UL_y=6418278-equator;
    UR_x=684414;
    UR_y=6418341-equator;
    LR_x=684438;
    LR_y=6418112-equator;
    LL_x=684257;
    LL_y=6418084-equator;

      elseif ROI==4

        % ROI Coordinates
    UL_x=670314;
    UL_y=6409630-equator;
    UR_x=670626;
    UR_y=6409620-equator;
    LR_x=670615;
    LR_y=6409309-equator;
    LL_x=670323;
    LL_y=6409317-equator;
...
MData_file=strcat(base, filesep, dates.name, filesep, '20181102_003531_56_1047_3B_AnalyticMS_metadata.xml');
...
for D_band=1:4 %dove band
    ...
    %Dove_image_file= strcat(base,filesep, dates.name, filesep, '003531_56_cubicspline.tif');
...
%     all_mean.L8.ROI(ROI,:) = mean_L8_TOArad;
     ...
     all_mean_NSW_Aus.D.ROI(ROI,:) = mean_D_TOArad;
     all_mean_NSW_Aus.L8.ROI(ROI,:) = mean_L8_TOArad;
    % all_mean.L8_2.ROI(ROI,:)= mean_L8_2_TOArad;
   
     all_mean_ref_NSW_Aus.D.ROI(ROI,:) = mean_D_TOAref;
     all_mean_ref_NSW_Aus.L8.ROI(ROI,:) = mean_L8_TOAref;
     
     %Standard Deviation- Radiance
     all_SD_NSW_Aus.D.ROI(ROI,:)= Std_D_TOArad;
     all_SD_NSW_Aus.L8.ROI(ROI,:)= Std_L8_TOArad;
     
     %Standard Deviation- Reflectance
     all_SD_ref_NSW_Aus.D.ROI(ROI,:)= Std_D_TOAref;
     all_SD_ref_NSW_Aus.L8.ROI(ROI,:)= Std_L8_TOAref;
     
     %Relative Standard Deviation from Radiance
     all_RSD_NSW_Aus.D.ROI(ROI,:) = Std_D_TOArad./mean_D_TOArad;
     all_RSD_NSW_Aus.L8.ROI(ROI,:) = Std_L8_TOArad./mean_L8_TOArad;
     
     %Relative Standard Deviation from Reflectance
     all_RSD_ref_NSW_Aus.D.ROI(ROI,:) = Std_D_TOAref./mean_D_TOAref;
     all_RSD_ref_NSW_Aus.L8.ROI(ROI,:) = Std_L8_TOAref./mean_L8_TOAref; 
end

    all_mean.Radiance.m_NSW_Aus1 = all_mean_NSW_Aus;
    all_mean.Reflectance.m_NSW_Aus1 = all_mean_ref_NSW_Aus;
    
    all_SD.Radiance.m_NSW_Aus1 = all_SD_NSW_Aus;
    all_SD.Reflectance.m_NSW_Aus1 = all_SD_ref_NSW_Aus;
    
    all_RSD.Radiance.m_NSW_Aus1 = all_RSD_NSW_Aus;
    all_RSD.Reflectance.m_NSW_Aus1 = all_RSD_ref_NSW_Aus;
