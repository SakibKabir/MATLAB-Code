...
% Dove File 
Dove_tif_name = '20190125_184143_93_1068_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190125_184143_93_1068_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 725225;  UL_y= 3561587;
 UR_x= 725801; UR_y= 3561500;
 LR_x= 725824;  LR_y= 3561270;
 LL_x= 725271;  LL_y= 3561157;

  elseif ROI==2
 UL_x= 700931;  UL_y= 3565056;
 UR_x= 701080; UR_y= 3565062;
 LR_x= 701085;  LR_y= 3564998;
 LL_x= 700939;  LL_y= 3564994;

  elseif ROI==3
 UL_x= 724749;  UL_y= 3563001;
 UR_x= 724915; UR_y= 3563081;
 LR_x= 724887;  LR_y= 3563015;
 LL_x= 724809;  LL_y= 3563003;

  elseif ROI==4
 UL_x= 701177;  UL_y= 3567904;
 UR_x= 701527;  UR_y= 3567901;
 LR_x= 701669;  LR_y= 3567589;
 LL_x= 701245;  LL_y= 3567492;
...
RefMat_dove = [0 -3; 3 0; 696552 3576801];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190125_93.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190125_93.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190125_93.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190125_93.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190125_93.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190125_93.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190125_93.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190125_93.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190125_93.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190125_93.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190125_93.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190125_93.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_1068.Radiance.a_IV_P038R038_190125_93 = all_mean_IV_P038R038_190125_93;
all_mean_DR_1068.Reflectance.a_IV_P038R038_190125_93 = all_mean_ref_IV_P038R038_190125_93;

all_SD_DR_1068.Radiance.a_IV_P038R038_190125_93 = all_SD_IV_P038R038_190125_93;
all_SD_DR_1068.Reflectance.a_IV_P038R038_190125_93= all_SD_ref_IV_P038R038_190125_93;

all_SNR_DR_1068.Radiance.a_IV_P038R038_190125_93 = all_SNR_IV_P038R038_190125_93;
all_SNR_DR_1068.Reflectance.a_IV_P038R038_190125_93 = all_SNR_ref_IV_P038R038_190125_93;
