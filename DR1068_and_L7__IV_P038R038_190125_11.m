...
% Dove File 
Dove_tif_name = '20190125_184148_11_1068_3B_AnalyticMS.tif';

%Extracting all the values from Metadata file
MData_file=fullfile(base, date, Directory.name, '20190125_184148_11_1068_3B_AnalyticMS_metadata.xml');
...
for ROI = 1: 4
  if ROI==1
    % ROI Coordinates
 UL_x= 696075;  UL_y= 3591032;
 UR_x= 696294;  UR_y= 3591039;
 LR_x= 696298;  LR_y= 3590880;
 LL_x= 696078;  LL_y= 3590871;

  elseif ROI==2
 UL_x= 716791;  UL_y= 3590252;
 UR_x= 718242; UR_y= 3590099;
 LR_x= 718351;  LR_y= 3589506;
 LL_x= 716836;  LL_y= 3589664;

  elseif ROI==3
 UL_x= 700123;  UL_y= 3586829;
 UR_x= 700278; UR_y= 3586723;
 LR_x= 700217;  LR_y= 3586635;
 LL_x= 700037;  LL_y= 3586699;


  elseif ROI==4
 UL_x= 706136;  UL_y= 3598484;
 UR_x= 706202; UR_y= 3598484;
 LR_x= 706193;  LR_y= 3598170;
 LL_x= 706027;  LL_y= 3598179;
...
RefMat_dove = [0 -3; 3 0; 690129 3605853];
...
Std_L7_TOAref(D_band)= std(temp_L7_ref);
 ...
 %Mean- Radiance
 all_mean_IV_P038R038_190125_11.D.ROI(ROI,:) = mean_D_TOArad;
 all_mean_IV_P038R038_190125_11.L7.ROI(ROI,:) = mean_L7_TOArad;
 
 %Mean- Reflectance
 all_mean_ref_IV_P038R038_190125_11.D.ROI(ROI,:) = mean_D_TOAref;
 all_mean_ref_IV_P038R038_190125_11.L7.ROI(ROI,:) = mean_L7_TOAref;

 %%% Standard Deviation
 %Standard Deviation- Radiance
 all_SD_IV_P038R038_190125_11.D.ROI(ROI,:)= Std_D_TOArad;
 all_SD_IV_P038R038_190125_11.L7.ROI(ROI,:)= Std_L7_TOArad;

 %Standard Deviation- Reflectance
 all_SD_ref_IV_P038R038_190125_11.D.ROI(ROI,:)= Std_D_TOAref;
 all_SD_ref_IV_P038R038_190125_11.L7.ROI(ROI,:)= Std_L7_TOAref;

 %%% Signal to Noise Ratio
 %SNR From Radiance
 all_SNR_IV_P038R038_190125_11.D.ROI(ROI,:) = mean_D_TOArad./Std_D_TOArad;
 all_SNR_IV_P038R038_190125_11.L7.ROI(ROI,:) = mean_L7_TOArad./Std_L7_TOArad;

 %SNR From Reflectance
 all_SNR_ref_IV_P038R038_190125_11.D.ROI(ROI,:) = mean_D_TOAref./Std_D_TOAref;
 all_SNR_ref_IV_P038R038_190125_11.L7.ROI(ROI,:) = mean_L7_TOAref./Std_L7_TOAref; 
end

all_mean_DR_1068.Radiance.a_IV_P038R038_190125_11 = all_mean_IV_P038R038_190125_11;
all_mean_DR_1068.Reflectance.a_IV_P038R038_190125_11 = all_mean_ref_IV_P038R038_190125_11;

all_SD_DR_1068.Radiance.a_IV_P038R038_190125_11 = all_SD_IV_P038R038_190125_11;
all_SD_DR_1068.Reflectance.a_IV_P038R038_190125_11= all_SD_ref_IV_P038R038_190125_11;

all_SNR_DR_1068.Radiance.a_IV_P038R038_190125_11 = all_SNR_IV_P038R038_190125_11;
all_SNR_DR_1068.Reflectance.a_IV_P038R038_190125_11 = all_SNR_ref_IV_P038R038_190125_11;
